    ...
    f.extend(b, {
        ...
        defaults: {
            ...
            tpl: {
                ...
                error: '<p class="fancybox-error">图片加载失败，请稍后再试。</p>',
                ...
                prev: '<a title="前一张" class="fancybox-nav fancybox-prev" href="javascript:;"><span></span></a>'
            },
            openEffect: "fade",
            openSpeed: 250,
            openEasing: "swing",
...
})(window, document, jQuery); (function(root, factory) {
...
function() {
    ...
    a.fn.backstretch = function(c, b) { (c === p || 0 === c.length) && a.error("No images were supplied for Backstretch");
    ...
    q.prototype = {
        ...
        show: function(c) {
            if (! (Math.abs(c) > this.images.length - 1)) {
                ...
                b.$img = a("<img />").css(s).bind("load",
                function(f) {
                    var h = this.width || a(f.target).width();
                    f = this.height || a(f.target).height();
                    a(this).data("ratio", h / f);
                    a(this).fadeIn(b.options.speed || b.options.fade,
                    function() {
                        e.remove();
                        b.paused || b.cycle();
...
$(document).ready(function() {
    ...
    /*$(".sidebar").backstretch(images,{fade:1500,duration:15000,})*/
});